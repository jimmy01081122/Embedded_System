 ...
 * 0 = black
 *
 * 將使用者看到的 128x80 landscape 座標
 * 轉成 controller RAM 的 80x128 portrait 座標。
 */
...
void EPD_ShowString(const char *text)
{
    ...
    /*
     * 溫度字串約 17 字元，5x7 字型寬度約 102 pixels。
     * 放在 x=8, y=36 可完整顯示在 128x80 內。
     */
...
void EPD_ShowTestPattern(void)
{
    ...
    EPD_DrawString5x7(10, 10, "HELLO");
    EPD_DrawString5x7(10, 30, "EPD");
    EPD_DrawString5x7(10, 50, "TEST");
...
{
    /*
     * Deep Sleep command 0x07, check code 0xA5。
     * 進入 deep sleep 後需硬體 reset 才能恢復。
     */
